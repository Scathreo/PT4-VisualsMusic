...
public class Vue_2D extends JPanel implements Observer {
   ...
   * couleurs spécifiques
   */
  private Color[] couleurs_trait_back;
  ...
  private void paintRectCouleur(Graphics g, int x, int numero_rectangle) {
    ...
    if (ratioFrequenceBackground != null) {
      ...
      if (ratioFrequenceBackground[numero_rectangle] != 0) {
      ...
      if (model.isThreeDimension())
        ...
        if (model.isCouleur_2d_random()) {
          ...
          if (model.getMode().equals("Ton")) {
            ...
            couleurs_forme_back = new Color[nombre_rectangle];

            for (int index = 0; index < couleurs_forme_back.length; index ++) {

              couleurs_forme_back[index] = new Color(
                  (float) Math.random(),
                  (float) Math.random(),
                  (float) Math.random()); 
            ...
            couleurs_trait_back = new Color[nombre_rectangle];

            for (int index = 0; index < couleurs_trait_back.length; index ++) {

              couleurs_trait_back[index] = new Color(
                  (float) Math.random(),
                  (float) Math.random(),
                  (float) Math.random()); 
